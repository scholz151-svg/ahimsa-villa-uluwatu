...
var translations = {
  de: {
    ...
    aboutIntro:  'Die Ahimsa Villa vereint modernes Design mit tropischem Charme \u2014 nur 5 Fahrminuten vom Herzen Uluwatus und den Highlights von Bingin entfernt. Mit Panoramablick auf den Ozean, offenem Wohnkonzept und lebendiger Surf-Atmosph\u00e4re ist sie der perfekte R\u00fcckzugsort f\u00fcr Gruppen und Familien.',
    aboutRoomsTitle: 'F\u00fcnf individuelle Schlafzimmer',
    aboutRoomsText: 'Jedes Schlafzimmer hat ein eigenes Bad und ist individuell gestaltet. Die Master-Suite bietet einen begehbaren Kleiderschrank und eine freistehende Badewanne. Klare Linien, gro\u00dfe Fenster und nat\u00fcrliche Materialien schaffen eine helle, einladende Atmosph\u00e4re.',
    aboutLivingTitle: 'Wohnen & Unterhaltung',
    aboutLivingText: 'Das Wohnzimmer bietet Poolblick, einen 55-Zoll-Fernseher und ein Karaoke-System mit Lautsprechern und Mikrofonen. Der ger\u00e4umige Essbereich mit gro\u00dfem Holztisch eignet sich perfekt f\u00fcr gemeinsame Abende, w\u00e4hrend die voll ausgestattete K\u00fcche mit hochwertigen Ger\u00e4ten zum Kochen einl\u00e4dt.',
    aboutServiceTitle: 'Exklusiv f\u00fcr dich',
    aboutServiceText: 'Die gesamte Villa mit Pool steht exklusiv nur dir und deiner Gruppe zur Verf\u00fcgung. Ein freundlicher Gastgeber ist vor Ort erreichbar, und das Reinigungs-, Garten- und Poolteam sorgt daf\u00fcr, dass alles gepflegt bleibt.',
    factGuests:   'G\u00e4ste',
    ...
    hlHairdryer: 'F\u00f6hn in jedem Zimmer',
    hlBlackout: 'Verdunklungsvorh\u00e4nge',
    hlKidsPool: 'Separater Kinderpool',
    hlSafety:   'Rauchmelder in jedem Zimmer',
    hlJBL:      'JBL Bluetooth-Soundsystem',
    hlOutdoorShower: 'Outdoor-Dusche',
    hlLoungers: 'Sonnenliegen am Pool',
    hlHousekeeping: 'T\u00e4gliche Haushaltshilfe',
    hlBoardGames: 'Brettspiele f\u00fcr Familien',
    hlFirstAid: 'Erste-Hilfe-Set & Feuerl\u00f6scher',
    hlHostGreeting: 'Pers\u00f6nliche Begr\u00fc\u00dfung durch Gastgeber',
    hlCottonLinen: 'Baumwoll-Bettw\u00e4sche',
    ...
    locGym:     'Fitnessstudios',
    locShops:   'Superm\u00e4rkte',
    locSpa:     'Spas & Beauty',
  ...
  en: {
    ...
    aboutIntro:  'Ahimsa Villa blends modern design with tropical charm \u2014 just a 5-minute drive from the heart of Uluwatu and the best of Bingin. With panoramic ocean views, open-plan living, and a vibrant surf atmosphere, it\'s the perfect retreat for groups and families.',
    aboutRoomsTitle: 'Five unique bedrooms',
    aboutRoomsText: 'Each bedroom has its own en-suite bathroom and unique design. The master suite features a walk-in closet and freestanding bathtub. Clean lines, large windows, and natural materials create a bright, welcoming atmosphere.',
    aboutLivingTitle: 'Living & Entertainment',
    aboutLivingText: 'The living room offers pool views, a 55-inch TV, a JBL Bluetooth sound system, and karaoke with microphones. The spacious dining area with a large wooden table is perfect for group evenings. The fully equipped kitchen features an LG fridge, HAFELE stainless steel stove, Nespresso machine, toaster, blender, and everything you need to cook.',
    aboutServiceTitle: 'Exclusively yours',
    aboutServiceText: 'The entire villa and pool are reserved exclusively for you and your group. A friendly host is available on site, and the cleaning, garden, and pool team ensures everything stays well-maintained.',
    factGuests:   'Guests',
    ...
    hlHairdryer: 'Hairdryer in every room',
    hlBlackout: 'Blackout curtains',
    hlKidsPool: 'Separate kids pool',
    hlSafety:   'Smoke detectors in every room',
    hlJBL:      'JBL Bluetooth sound system',
    hlOutdoorShower: 'Outdoor shower',
    hlLoungers: 'Sun loungers by the pool',
    hlHousekeeping: 'Daily housekeeping',
    hlBoardGames: 'Board games for families',
    hlFirstAid: 'First aid kit & fire extinguisher',
    hlHostGreeting: 'Personal host greeting',
    hlCottonLinen: 'Cotton bed linens',
